...
\begin{frame}{The Anarchist Ideal Conflicts with the Centralized Reality}
    \centering
    \includegraphics[height=0.85\textheight]{internet-cable-map}
\end{frame}
...
\begin{frame}{SCA: Who + What + How}
    \centering
    \includegraphics[height=0.8\textheight]{sca-table}\\
    \tiny
...
\begin{frame}{The Site That Made the Dark Web Famous:}
    \centering
    \includegraphics[height=0.85\textheight]{silkroad-seized}
\end{frame}
...
\begin{frame}{Possible Response: The "Break Up" Flow}
    \centering
    \includegraphics[height=0.85\textheight]{breakup-flow}
\end{frame}
...
\begin{frame}{Smart Home: Convenience or Abuse?}
    \centering
    \includegraphics[height=0.85\textheight]{smart-home}
\end{frame}
...
\begin{frame}{Public: Wassenaar and Other Attempts to Regulate Spyware}
    ...
    \footnotesize
    \underline{\href{https://www.wassenaar.org/the-wassenaar-arrangement/}{wassenaar.org}}
    \begin{columns}
        \column{0.5\textwidth}
