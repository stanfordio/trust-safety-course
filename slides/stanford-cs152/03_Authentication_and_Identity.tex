...
\begin{frame}{}
    \includegraphics[width=\textwidth]{stanford-forgot-password}
\end{frame}
...
\begin{frame}{}
    \centering
    \includegraphics[height=0.9\paperheight]{have-i-been-pwned}
\end{frame}

\begin{frame}{}
    \thispagestyle{empty}
    \AddToShipoutPictureBG*{\adjincludegraphics[trim=0 {0.5\height} 0 0, clip, width=\paperwidth]{predator13}}
\end{frame}
...
\begin{frame}{}
    \thispagestyle{empty}
    \centering
    \AddToShipoutPictureBG*{\includegraphics[width=\paperwidth]{anatomy-of-phishing-mail}}
\end{frame}

\begin{frame}{}
    \thispagestyle{empty}
    \centering
    \AddToShipoutPictureBG*{\includegraphics[width=\paperwidth]{login-diagram}}
\end{frame}

\begin{frame}{}
    \thispagestyle{empty}
    \AddToShipoutPictureBG*{\includegraphics[width=\paperwidth]{login-diagram-phishing}}
\end{frame}

\begin{frame}{}
    \thispagestyle{empty}
    \AddToShipoutPictureBG*{\includegraphics[width=\paperwidth]{bad-link-browser}}
\end{frame}
...
\begin{frame}{}
    \thispagestyle{empty}
    \AddToShipoutPictureBG*{\includegraphics[height=\paperheight]{evilginx}}
\end{frame}
...
\begin{frame}{}
    \thispagestyle{empty}
    \AddToShipoutPictureBG*{\includegraphics[trim=200 0 0 0, clip, height=\paperheight]{auth-key}}
\end{frame}

\begin{frame}{}
    %TODO how to implement w/ or w/o animation
\end{frame}
...
\begin{frame}{}
    \thispagestyle{empty}
    \AddToShipoutPictureBG*{\includegraphics[width=\paperwidth]{phishy}}
\end{frame}
