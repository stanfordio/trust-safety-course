...
\begin{frame}{What Will You Learn Today?}%TODO consistent sizing + formatting for overview pages
    \large
    \begin{itemize}
...
\begin{frame}{}%TODO crop
    \thispagestyle{empty}
    \AddToShipoutPictureBG*{\includegraphics[width=\paperwidth]{predator13}}
\end{frame}
...
\begin{frame}{}%TODO2 fix
    \thispagestyle{empty}
    \includegraphics[height=\paperheight]{bad-link-mobile}
\end{frame}

\begin{frame}{}%TODO2 fix - AtPageUpperLeft not doing what eso-pic says it does
    \thispagestyle{empty}
...
\begin{frame}{Authentication Beyond Passwords}
    \centering
    \includegraphics[height=\textheight]{stanford-2fa}
\end{frame}

\begin{frame}{}%TODO scaling
    \thispagestyle{empty}
    \AddToShipoutPictureBG*{\includegraphics[width=\paperwidth]{auth-key}}
\end{frame}
...
\begin{frame}{}%TODO HOW DO YOU CENTER THIS AAAAAAAA
    \thispagestyle{empty}
    \centering
    \includegraphics[width=\textwidth]{phishy}
\end{frame}

\begin{frame}{}%TODO cursed alignment
    \thispagestyle{empty}
